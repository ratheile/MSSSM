...
This subchapter shall give a visual explanation of how the logic functions work. Lets consider the situation given in \ref{Bsp1}.
\begin{figure}[h!]
	\centering
