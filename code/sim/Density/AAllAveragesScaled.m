...
hold on;
plot(0.1:0.1:120, AIS1up1downAvgScaled, 0.1:0.1:120, AIS1up08downAvgScaled, 0.1:0.1:120, AIS1up06downAvgScaled, 0.1:0.1:120, AIS1up04downAvgScaled, 0.1:0.1:120, AIS08up08downAvgScaled, 0.1:0.1:120, AIS08up06downAvgScaled, 0.1:0.1:120, AIS08up04downAvgScaled);
plot(0.1:0.1:120, AIS06up06downAvgScaled, 'Color', [1 0 1]);
