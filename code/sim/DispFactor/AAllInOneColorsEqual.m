%Part 1 of 3 of "all in one" plots. Data "normalized" (total distance :
%#agents), and coloured (blue=low dispFac ; red=high dispFac). Because the
%colors are "gone through" three times, red is a bit dominant because drawn
%last, but not very much -> "equal".
