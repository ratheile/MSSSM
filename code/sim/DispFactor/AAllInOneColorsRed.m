%Part 2 of 3 of "all in one" plots. Data "normalized" (total distance :
%#agents), and coloured (blue=low dispFac ; red=high dispFac). Because the
%colors are "gone through" from blue to red, red is drawn last and is very
%dominant in the plot -> "red".
